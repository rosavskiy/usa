    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full p-6 relative">
        ...
        <p className="text-gray-700 mb-6">
          To proceed with AI-powered data extraction, <strong>1 credit</strong> will be
          deducted from your balance for this document.
        </p>
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-3 text-sm text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Precision OCR:</strong> Automated extraction of energy and fuel
                consumption.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary-600 font-bold">•</span>
              <span>
                <strong>EPA eGRID Integration:</strong> Calculations based on the latest
            ...
            <li className="flex items-start gap-2">
              <span className="text-primary-600 font-bold">•</span>
              <span>
                <strong>Standard Compliance:</strong> Data will be formatted according to
                the <strong>GHG Protocol Corporate Standard</strong>.
              </span>
            </li>
          </ul>
        </div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Once processed, you can review the results in the <strong>Calculations</strong>{" "}
          tab and export your audit-ready PDF Report.
        </p>
