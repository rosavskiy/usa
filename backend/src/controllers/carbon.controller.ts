...
export const calculateCarbon = asyncHandler(async (
  req: AuthRequest,
  res: Response
) => {
...
export const getCalculations = asyncHandler(async (
  req: AuthRequest,
  res: Response
) => {
  const userId = req.userId!;
...
export const getRecommendations = asyncHandler(async (
  req: AuthRequest,
  res: Response
) => {
  const userId = req.userId!;
...
export const exportReport = asyncHandler(async (
  req: AuthRequest,
  res: Response
) => {
  const userId = req.userId!;
